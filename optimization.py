...
def optimize_model(optimizer, memory, policy_net, target_net, batch_size, discount_factor):
    ...
    # clamp gradients to avoid exploding gradient (even though LSTM is used)
