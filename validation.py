...
def signR(prices, t):
    rets = (prices[:, t-251:t+1] - prices[:, t-252:t])
...
if __name__ == '__main__':
    ...
    # load DQN params and set model to eval mode
    params1_dqn = torch.load("models/dqn_{}_{}_{}.pt".format(asset_type, 2006, 2010))
    params2_dqn = torch.load("models/dqn_{}_{}_{}.pt".format(asset_type, 2011, 2015))
    ...
    pg_actions_prev = torch.zeros(len(S), device=device)
    ...
    for t in test_idx:
        ...
        dqn_actions = dqn.get_actions(states)
    ...
    plt.savefig("plots/{}_{}_{}.png".format(asset_type, min_year, max_year),
